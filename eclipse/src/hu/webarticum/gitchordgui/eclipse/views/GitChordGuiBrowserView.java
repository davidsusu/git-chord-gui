...
public class GitChordGuiBrowserView extends ViewPart implements ISelectionListener {

	/**
	 * The ID of the view as specified by the extension.
	 */
	public static final String ID = "hu.webarticum.gitchordgui.eclipse.views.BrowserView";
	...
	public String getContent() {
		...
		buffer.append("<title>Git Chord GUI</title>");
		buffer.append("<script>" + js + "</script>");
		buffer.append("</script>");
		buffer.append("</head>");
		buffer.append("<body>");
		buffer.append("<h1>Git Chord GUI</h1>");
		buffer.append("<div id=\"selection\"></div>");
		buffer.append("<h2>Example</h2>");
		buffer.append("<div id=\"lastAction\"></div>");
		buffer.append("<h3>Hello, Git Chord!</h3>");
